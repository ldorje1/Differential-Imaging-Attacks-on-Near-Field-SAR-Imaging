...
(1) **(1) Global Loss (Full-Image Attack):**  :The L2 loss is computed over all pixels in the reconstructed image. This forces the attack to globally reshape the entire SAR volume toward the target. Stronger but more power-demanding; produces large structural changes.
